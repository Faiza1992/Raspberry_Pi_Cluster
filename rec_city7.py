...
def receive_and_forward_packets(receive_ip, receive_port, forward_ip, forward_port):
    ...
    csv_filename = 'packet_latency_log_7.csv'
    rec_packets=0
...
if __name__ == "__main__":
    ...
    listen_ip = "192.168.1.8"
    listen_port = 5000
    
    # IP and port to forward to
    forward_ips = ["192.168.1.9", "192.168.1.6"]
    forward_ip =random.choice(forward_ips)
    print(f"Random cholice :{forward_ip}")
    forward_port = 5000
